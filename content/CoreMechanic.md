...
- ### Struktur Permainan
  ...
  - Sebelum sesi dimulai, dilakukan pengacakan apa [[Role|role]] dari player character maupun AI character
  - ##### Timer
...
- #### Win condition
  - Player character menang jika berhasil memenuhi objective dari [[Role|role]]-nya pada ronde tersebut

* #### Lose condition
  - Player character kalah jika gagal memenuhi objective dari [[Role|role]]-nya pada ronde tersebut
    ![[Role]]
