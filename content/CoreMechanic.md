- ### Character
  ...
  - Ketika melakukan movement, character menggunakan stamina
...
- ### Struktur Permainan
  - #### End condition
    ...
    - Sebelum sesi dimulai, dilakukan pengacakan apa [[#^1661e5 |role]] dari player character maupun AI character
    - ##### Timer
      - 1 ronde dilaksanakan selama 1 menit (real-life time)
    - #### Win condition
      - Player character menang jika berhasil memenuhi objective dari [[#^1661e5 |role]]-nya pada ronde tersebut
    - #### Lose condition
      - Player character kalah jika gagal memenuhi objective dari [[#^1661e5 |role]]-nya pada ronde tersebut
